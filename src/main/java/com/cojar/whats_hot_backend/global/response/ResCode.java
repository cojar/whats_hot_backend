...
public enum ResCode {
    ...
    F_03_02_02(HttpStatus.BAD_REQUEST, "F-03-02-02", "해당 장소에 달린 리뷰가 없습니다"),
    F_03_02_03(HttpStatus.BAD_REQUEST, "F-03-02-03", "허용되지 않는 페이지 당 댓글 개수입니다"),
    F_03_02_04(HttpStatus.BAD_REQUEST, "F-03-02-04", "존재하지 않는 페이지입니다"),
    F_03_02_05(HttpStatus.BAD_REQUEST, "F-03-02-05", "허용되지 않는 정렬 옵션입니다"),
    ...
    F_03_04_02(HttpStatus.BAD_REQUEST, "F-03-04-02", "해당 리뷰에 대한 수정 권한이 없습니다"),
    F_03_04_03(HttpStatus.BAD_REQUEST, "F-03-04-03", "요청 값이 올바르지 않습니다"),
