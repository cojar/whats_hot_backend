...
public enum ResCode {
    ...
    F_02_03_01(HttpStatus.BAD_REQUEST, "F-02-03-01", "해당 아이디를 가진 장소가 존재하지 않습니다"),
    ...
    F_03_04_04(HttpStatus.BAD_REQUEST, "F-03-04-04", "평점은 0.0에서 5.0 사이, 0.5점 단위로 입력해주세요"),
    ...
    F_99_99_06(HttpStatus.BAD_REQUEST, "F-99-99-06", "입력 타입이 올바르지 않습니다"),
