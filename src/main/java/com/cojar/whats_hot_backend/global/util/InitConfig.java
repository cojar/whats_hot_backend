...
//            Map<String, Review> reviewInit = new HashMap<>();
//            List<Review> reviewList = new ArrayList<>();
//
//            for (int i = 0; i < 204; i++) {
//                // 여기에서 필요한 spotId, memberId 등을 정확하게 지정해야 합니다.
//                Review review = this.reviewService.create(
//                        ReviewRequest.CreateReview.builder()
//                                .spotId(spot1.getId()) // 예시로 지정된 변수
//                                .year(2024)
//                                .month(1)
//                                .day(1)
//                                .title("테스트" + (i + 1))
//                                .content("test" + (i + 1))
//                                .score(1.0)
//                                .hashtags(List.of("해시태그" + (i + 1), "해시태그" + i))
//                                .build(),
//                        List.of(new MockMultipartFile(
//                                "images",
//                                "test.png",
...
//                        )),
//                        AppConfig.getMockErrors(),
//                        AppConfig.toUser(memberInit.get("user1"))
//                );
//
//                reviewList.add(review);
//                reviewInit.put("review" + (i + 1), review);
//            }
...
//                            )),
//                            AppConfig.getMockErrors(),
//                            AppConfig.toUser(memberInit.get("user2"))
//                    );
//
//            Review
//                    review3
...
//                    );
//
//            Map<String, Comment> commentInit = new HashMap<>();
//
//            commentInit.put("comment1", commentService.create(
